...
var (
	Chrome126 = createChrome126()
	Chrome126UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Mobile Safari/537.36"
)

func createChrome126() *profiles.ClientProfile {
	var (
