...
var (
	Chrome83 = createChrome83()
	Chrome83UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36"
)

func createChrome83() *profiles.ClientProfile {
	var (
