...
var (
	Chrome128 = createChrome128()
	Chrome128UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Mobile Safari/537.36"
)

func createChrome128() *profiles.ClientProfile {
	var (
