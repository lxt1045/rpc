...
var (
	Chrome118 = createChrome118()
	Chrome118UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Mobile Safari/537.36"
)

func createChrome118() *profiles.ClientProfile {
	var (
