...
var (
	Chrome107 = createChrome107()
	Chrome107UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/107.0.0.0 Mobile Safari/537.36"
)

func createChrome107() *profiles.ClientProfile {
	var (
