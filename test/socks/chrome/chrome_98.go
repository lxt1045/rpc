...
var (
	Chrome98 = createChrome98()
	Chrome98UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/98.0.4758.101 Mobile Safari/537.36"
)

func createChrome98() *profiles.ClientProfile {
	var (
