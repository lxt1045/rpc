...
var (
	Chrome138 = createChrome138()
	Chrome138UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Mobile Safari/537.36"
)

func createChrome138() *profiles.ClientProfile {
	var (
