...
var (
	Chrome109 = createChrome109()
	Chrome109UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/109.0.0.0 Mobile Safari/537.36"
)

func createChrome109() *profiles.ClientProfile {
	var (
