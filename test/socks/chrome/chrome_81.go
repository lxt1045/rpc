...
var (
	Chrome81 = createChrome81()
	Chrome81UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36"
)

func createChrome81() *profiles.ClientProfile {
	var (
