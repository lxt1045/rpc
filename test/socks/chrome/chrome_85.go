...
var (
	Chrome85 = createChrome85()
	Chrome85UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.127 Mobile Safari/537.36"
)

func createChrome85() *profiles.ClientProfile {
	var (
