...
var (
	Chrome112 = createChrome112()
	Chrome112UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36"
)

func createChrome112() *profiles.ClientProfile {
	var (
