...
var (
	Chrome89 = createChrome89()
	Chrome89UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36"
)

func createChrome89() *profiles.ClientProfile {
	var (
