...
var (
	Chrome103 = createChrome103()
	Chrome103UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/103.0.0.0 Mobile Safari/537.36"
)

func createChrome103() *profiles.ClientProfile {
	var (
