...
var (
	Chrome90 = createChrome90()
	Chrome90UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36"
)

func createChrome90() *profiles.ClientProfile {
	var (
