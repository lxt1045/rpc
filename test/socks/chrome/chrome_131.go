...
var (
	Chrome131 = createChrome131()
	Chrome131UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/131.0.0.0 Mobile Safari/537.36"
)

func createChrome131() *profiles.ClientProfile {
	var (
