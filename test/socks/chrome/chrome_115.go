...
var (
	Chrome115 = createChrome115()
	Chrome115UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Mobile Safari/537.36"
)

func createChrome115() *profiles.ClientProfile {
	var (
