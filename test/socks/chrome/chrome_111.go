...
var (
	Chrome111 = createChrome111()
	Chrome111UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36"
)

func createChrome111() *profiles.ClientProfile {
	var (
