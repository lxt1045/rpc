...
var (
	Chrome88 = createChrome88()
	Chrome88UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.181 Mobile Safari/537.36"
)

func createChrome88() *profiles.ClientProfile {
	var (
