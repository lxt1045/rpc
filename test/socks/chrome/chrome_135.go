...
var (
	Chrome135 = createChrome135()
	Chrome135UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Mobile Safari/537.36"
)

func createChrome135() *profiles.ClientProfile {
	var (
