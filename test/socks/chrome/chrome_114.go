...
var (
	Chrome114 = createChrome114()
	Chrome114UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36"
)

func createChrome114() *profiles.ClientProfile {
	var (
