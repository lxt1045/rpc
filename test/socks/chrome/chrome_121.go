...
var (
	Chrome121 = createChrome121()
	Chrome121UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36"
)

func createChrome121() *profiles.ClientProfile {
	var (
