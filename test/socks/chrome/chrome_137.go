...
var (
	Chrome137 = createChrome137()
	Chrome137UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Mobile Safari/537.36"
)

func createChrome137() *profiles.ClientProfile {
	var (
