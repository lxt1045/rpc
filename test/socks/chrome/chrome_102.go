...
var (
	Chrome102 = createChrome102()
	Chrome102UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/102.0.0.0 Mobile Safari/537.36"
)

func createChrome102() *profiles.ClientProfile {
	var (
