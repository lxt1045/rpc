...
var (
	Chrome101 = createChrome101()
	Chrome101UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/101.0.0.0 Mobile Safari/537.36"
)

func createChrome101() *profiles.ClientProfile {
	var (
