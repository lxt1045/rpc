...
var (
	Chrome93 = createChrome93()
	Chrome93UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Mobile Safari/537.36"
)

func createChrome93() *profiles.ClientProfile {
	var (
