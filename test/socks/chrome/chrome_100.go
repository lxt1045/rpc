...
var (
	Chrome100 = createChrome100()
	Chrome100UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36"
)

func createChrome100() *profiles.ClientProfile {
	var (
