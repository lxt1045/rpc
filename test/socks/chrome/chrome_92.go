...
var (
	Chrome92 = createChrome92()
	Chrome92UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.166 Mobile Safari/537.36"
)

func createChrome92() *profiles.ClientProfile {
	var (
