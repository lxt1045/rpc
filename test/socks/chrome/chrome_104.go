...
var (
	Chrome104 = createChrome104()
	Chrome104UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/104.0.0.0 Mobile Safari/537.36"
)

func createChrome104() *profiles.ClientProfile {
	var (
