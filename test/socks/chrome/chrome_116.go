...
var (
	Chrome116 = createChrome116()
	Chrome116UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36"
)

func createChrome116() *profiles.ClientProfile {
	var (
