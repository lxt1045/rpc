...
var (
	Chrome106 = createChrome106()
	Chrome106UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/106.0.0.0 Mobile Safari/537.36"
)

func createChrome106() *profiles.ClientProfile {
	var (
