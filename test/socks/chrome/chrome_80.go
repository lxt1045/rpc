...
var (
	Chrome80 = createChrome80()
	Chrome80UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.162 Mobile Safari/537.36"
)

func createChrome80() *profiles.ClientProfile {
	var (
