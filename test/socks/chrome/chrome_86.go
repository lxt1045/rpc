...
var (
	Chrome86 = createChrome86()
	Chrome86UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Mobile Safari/537.36"
)

func createChrome86() *profiles.ClientProfile {
	var (
