...
var (
	Chrome84 = createChrome84()
	Chrome84UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 Mobile Safari/537.36"
)

func createChrome84() *profiles.ClientProfile {
	var (
