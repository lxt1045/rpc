...
var (
	Chrome125 = createChrome125()
	Chrome125UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Mobile Safari/537.36"
)

func createChrome125() *profiles.ClientProfile {
	var (
