...
var (
	Chrome127 = createChrome127()
	Chrome127UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36"
)

func createChrome127() *profiles.ClientProfile {
	var (
