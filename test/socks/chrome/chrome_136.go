...
var (
	Chrome136 = createChrome136()
	Chrome136UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Mobile Safari/537.36"
)

func createChrome136() *profiles.ClientProfile {
	var (
