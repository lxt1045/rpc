...
var (
	Chrome99 = createChrome99()
	Chrome99UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/99.0.4844.88 Mobile Safari/537.36"
)

func createChrome99() *profiles.ClientProfile {
	var (
