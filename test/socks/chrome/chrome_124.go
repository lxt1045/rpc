...
var (
	Chrome124 = createChrome124()
	Chrome124UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36"
)

func createChrome124() *profiles.ClientProfile {
	var (
