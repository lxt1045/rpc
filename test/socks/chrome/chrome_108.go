...
var (
	Chrome108 = createChrome108()
	Chrome108UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/108.0.0.0 Mobile Safari/537.36"
)

func createChrome108() *profiles.ClientProfile {
	var (
