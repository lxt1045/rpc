...
var (
	Chrome105 = createChrome105()
	Chrome105UA = "Mozilla/5.0 (Linux; Android 14; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/105.0.0.0 Mobile Safari/537.36"
)

func createChrome105() *profiles.ClientProfile {
	var (
