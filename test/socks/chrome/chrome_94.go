...
var (
	Chrome94 = createChrome94()
	Chrome94UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/94.0.4606.85 Mobile Safari/537.36"
)

func createChrome94() *profiles.ClientProfile {
	var (
