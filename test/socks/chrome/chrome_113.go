...
var (
	Chrome113 = createChrome113()
	Chrome113UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Mobile Safari/537.36"
)

func createChrome113() *profiles.ClientProfile {
	var (
