...
var (
	Chrome87 = createChrome87()
	Chrome87UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36"
)

func createChrome87() *profiles.ClientProfile {
	var (
