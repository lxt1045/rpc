...
var (
	Chrome95 = createChrome95()
	Chrome95UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36"
)

func createChrome95() *profiles.ClientProfile {
	var (
