...
var (
	Chrome122 = createChrome122()
	Chrome122UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Mobile Safari/537.36"
)

func createChrome122() *profiles.ClientProfile {
	var (
