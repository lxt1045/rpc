...
var (
	Chrome97 = createChrome97()
	Chrome97UA = "Mozilla/5.0 (Linux; Android 10; MI 6) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/97.0.4692.98 Mobile Safari/537.36"
)

func createChrome97() *profiles.ClientProfile {
	var (
