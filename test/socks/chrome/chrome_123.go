...
var (
	Chrome123 = createChrome123()
	Chrome123UA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Mobile Safari/537.36"
)

func createChrome123() *profiles.ClientProfile {
	var (
